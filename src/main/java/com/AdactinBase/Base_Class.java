...
public class Base_Class {
    ...
    public static WebDriver browserLaunch(String browser) {
   	 ...
   	 if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver","C:\\Users\\Jose\\eclipse-workspace\\MavenDecember\\driver\\chromedriver.exe");
			driver = new ChromeDriver();
		}
		else if (browser.equalsIgnoreCase("Firefox")) {
			System.setProperty("webdriver.gecko.driver","C:\\Users\\Jose\\eclipse-workspace\\MavenDecember\\driver\\geckodriver.exe");
			driver = new FirefoxDriver();	
		}
		else if (browser.equalsIgnoreCase("ie")) {
			System.setProperty("webdriver.ie.driver","C:\\Users\\Jose\\eclipse-workspace\\MavenDecember\\driver\\IEDriverServer.exe");
